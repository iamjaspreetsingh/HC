        ...
        spinner.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alert.setPositiveButton("Set", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        problems[0] =("");
                        if (!checkedTextView.isChecked()) problems[0] =problems[0] +("Maids for sweeping ");
                         if (!checkedTextView1.isChecked()) problems[0] =problems[0] +("Full time Housekeepers ");
                          if (!checkedTextView2.isChecked()) problems[0] =problems[0] +("Babysitting / Adult Care ");
                          if (!checkedTextView3.isChecked()) problems[0] =problems[0] +("Guards ");
                         if (!checkedTextView4.isChecked()) problems[0] =problems[0] +("Washing clothes ");
                         if (!checkedTextView5.isChecked()) problems[0] =problems[0] +("Washing dishes ");
